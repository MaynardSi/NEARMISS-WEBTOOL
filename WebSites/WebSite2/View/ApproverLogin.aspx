<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApproverLogin.aspx.cs" Inherits="View_Default3" %>
    ...
    <div class="container login-main" id="page-wrap">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <form role="form" action="ApproverViewNearMissCases.aspx">
...
illness, or damage but had the potential to do so.">What is a Near Miss?</a>
            <br/>
            <br/>
            <a href="UserLogin.aspx">User</a> | <a href="AdminLogin.aspx">Administrator</a>
        </div>
    </div>
</body>
</html>
